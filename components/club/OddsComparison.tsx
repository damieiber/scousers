      ...
      <CardContent className="space-y-4">
        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-2 mb-4">
          <p className="text-[10px] text-yellow-600 font-medium text-center">
            ⚠️ Informativo. Las cuotas pueden variar. Jugar compulsivamente es perjudicial para la salud.
          </p>
        </div>

        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="text-xs font-bold text-muted-foreground uppercase mb-2">Local</div>
          <div className="text-xs font-bold text-muted-foreground uppercase mb-2">Empate</div>
          <div className="text-xs font-bold text-muted-foreground uppercase mb-2">Visitante</div>
